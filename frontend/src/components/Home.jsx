function Home() {
  const features = [
    { text: 'Record your expenses and categorize them', symbol: '💰' },
    { text: 'View a summary of your spending', symbol: '📊' },  
    { text: 'Analyze your expenses with charts and graphs', symbol: '📈' },
    { text: 'Set budget goals and track your progress', symbol: '🎯' },
  ];
